...
int melody[] = {
  ...
  NOTE_B5, -4, NOTE_A5, 8, NOTE_G5, 4, NOTE_A5, 8, NOTE_B5, 8, 
  NOTE_C6, -4, NOTE_G5, 8, NOTE_E5, 4, NOTE_G5, 8, NOTE_C6, 8, 
 ...
 NOTE_A5, -4, NOTE_G5, 8, NOTE_FS5, 4, NOTE_G5, 8, NOTE_A5, 8, 
 NOTE_B5, -4, NOTE_A5, 8, NOTE_G5, 4, NOTE_A5, 8, NOTE_B5, 8, 
 NOTE_C6, 8, NOTE_G5, 8, NOTE_C6, 8, NOTE_B5, 4, NOTE_B5, 8,
 NOTE_AS5, 8, NOTE_F5, 8, NOTE_AS5, 8, NOTE_B5, 4, NOTE_B5, 8,
  //lines 6-7 (abhi)
  // Abhi starting code :) 
    NOTE_C6, 8, NOTE_G5, 8, NOTE_C6, 8, NOTE_B5, 4, NOTE_B5, 8, 
    NOTE_AS5, 8, NOTE_F5, 8, NOTE_AS5, 8, NOTE_B5, 4, NOTE_B5, 8,  
    NOTE_C6, 8, NOTE_G5, 8, NOTE_C6, 8, NOTE_C6, 8, NOTE_G5, 8, NOTE_C6, 8, 
    NOTE_G5, -4, NOTE_FS5, 4, NOTE_FS5, 8, 
    NOTE_C6, 8, NOTE_G5, 8, NOTE_C6, 8, NOTE_C6,8, NOTE_G5, 8, NOTE_C6, 8, 
    NOTE_G5, -4, NOTE_FS5, 4, NOTE_FS5, 8, 
    NOTE_C6, 8, NOTE_G5, 8, NOTE_CS6, 8, NOTE_CS6, 8, NOTE_G5, 8, NOTE_CS6, 8, 
    
    NOTE_CS6, -4, NOTE_CS6, 4, NOTE_CS6, 8, 
    NOTE_D6, 8, NOTE_AS5, -8, NOTE_D6, 8, NOTE_D6, 8, NOTE_AS5, 8, NOTE_D6, 8,  
    NOTE_D6, -4, NOTE_D6, 4, NOTE_CS6, 8, 
    NOTE_D6, 4, NOTE_CS6, 8, NOTE_D6, 4, NOTE_CS6, 8, 
    NOTE_FS6, 8, NOTE_E6, 8, NOTE_CS6, 8, NOTE_AS5, 8, NOTE_FS5, 8, NOTE_E5, 8, NOTE_CS5, 8, NOTE_AS4, 8, 

  //lines 8-9 (jose)
  //silly little starting code by jose
   NOTE_FS4, 8, NOTE_E4, 8, NOTE_C4, 8, NOTE_AS3, 8, NOTE_DS3, 8, NOTE_CS3, 8, NOTE_B3, 8, NOTE_AS3, 8, 
   NOTE_FS5, 2, NOTE_B4, 8, NOTE_CS5, 8, NOTE_D5, 8, NOTE_E5, 8, 
